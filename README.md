...
- [shell scripting cheat sheet](https://periwinkle-tamarillo-73e.notion.site/Getting-started-c5740f3219004566ba9b516811e770f0)
...
- [looking around](http://linuxcommand.org/lc3_lts0020.php)
- [guided tour of linux directories](http://linuxcommand.org/lc3_lts0040.php)
- [file system hierarchy standard](https://refspecs.linuxfoundation.org/fhs.shtml)
- [manipulating files](http://linuxcommand.org/lc3_lts0050.php)
- [working with commands](http://linuxcommand.org/lc3_lts0060.php)
- [working with man pages](http://linuxcommand.org/lc3_man_pages/man1.html)
- [keyboard shortcuts for bash](https://www.howtogeek.com/181/keyboard-shortcuts-for-bash-command-shell-for-ubuntu-debian-suse-redhat-linux-etc/)
- [shebang](https://en.wikipedia.org/wiki/Shebang_%28Unix%29)
- [symbolic links](http://linuxcommand.org/lc3_man_pages/ln1.html)
- [symbolic links 2](https://www.freecodecamp.org/news/linux-ln-how-to-create-a-symbolic-link-in-linux-example-bash-command/#:~:text=You%20use%20the%20ln%20command,create%20the%20symbolic%20link%20for.)
- [magic files](https://www.youtube.com/watch?v=fVOd3Dxifms)
- [copy file permissions](https://www.tecmint.com/copy-file-permissions-and-ownership-to-another-file-in-linux/)
...
- [groups](https://www.makeuseof.com/linux-file-ownership-groups-guide/)
